...
// import styles from "./SingleArticleScreen.module.css"; // Import dello stile CSS

// const SingleArticleScreen: React.FC = () => {
//   const { id } = useParams<{ id: string }>(); // Prendiamo l'ID dall'URL
...
//           <img src={article.strArticleThumb} alt={article.strArticle} className={styles.img} />
